            ...
            match ty {
                ...
                types::I64 => {
                    ...
                    let has_overflow = if !signed {
                        ...
                        fx.bcx.ins().icmp_imm_s(IntCC::NotEqual, val_hi, 0)
                    } else {
                        ...
                        let val_sign = fx.bcx.ins().sshr_imm_s(val, i64::from(ty.bits() - 1));
                        let xor = fx.bcx.ins().bxor(val_hi, val_sign);
                        fx.bcx.ins().icmp_imm_s(IntCC::NotEqual, xor, 0)
                    };
                    (val, has_overflow)
                }
                types::I128 => {
    ...
    if is_thin_ptr {
        match bin_op {
            ...
            BinOp::Offset => {
                ...
                let ptr_diff = fx.bcx.ins().imul_imm_s(offset, pointee_size as i64);
