...
unstable_cli_options!(
    ...
    artifact_cache: bool = ("Reuse verified ordinary-library artifacts from a shared content cache"),
    ...
    sld_native_incremental: bool = ("Preserve macOS arm64 root executable outputs for SLD incremental relinks"),
...
impl CliUnstable {
    ...
    fn add(&mut self, flag: &str, warnings: &mut Vec<String>) -> CargoResult<()> {
        ...
        match k {
            ...
            "artifact-cache" => self.artifact_cache = parse_empty(k, v)?,
            ...
            "sld-native-incremental" => self.sld_native_incremental = parse_empty(k, v)?,
